...
export default function CTA() {
  ...
  return (
    <section>
      <div className="mt-5 lg:mt-[150px] xl:mt-[170px] 2xl:mt-[250px] 3xl:mt-[280px] bg-[#F8F8F8] font-inter-regular">
        <div className="container flex flex-col md:flex-row 3xl:w-[82.5rem]">
          ...
          <div className="flex md:w-1/2 py-2.5 lg:py-10 2xl:py-[50px] 2xl:pl-[8.5rem]">
            <div className="m-auto md:m-5 md:ml-auto xl:m-auto w-4/5 sm:w-3/5 md:w-full py-10 md:py-0">
              ...
              <ul className="pl-0 pt-6 md:pt-4 lg:pt-6 text-black-core/[0.6] text-base leading-5 md:text-[1.05rem] md:leading-[1.34rem] lg:text-[1.188rem] lg:leading-6 xl:text-[1.375rem] xl:leading-[1.8125rem] font-inter-semibold">
              ...
              <div className="pt-6 md:pt-4 lg:pt-6 text-black-core/[0.6] font-inter-regular text-sm leading-[1.125rem] md:text-[0.9rem] md:leading-[1.15rem] lg:text-lg lg:leading-[1.375rem] xl:text-[1.375rem] xl:leading-[1.813rem]">
