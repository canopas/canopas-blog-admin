  ...
  return (
    <>
      <div className="container flex items-center justify-center flex-col my-0 mx-auto py-60 px-[5%] min-h-[50vh]">
        ...
        <div className="mt-8 text-center text-[1.4rem] leading-8">
          The page you’re looking for was moved, renamed or might never existed.
        </div>
        <div className="hover:text-[#fff]">
          <Link
            className="gradient-border-btn hover:text-[#fff] rounded-[0.6rem] p-[1rem] m-[5px] text-center border border-solid border-transparent from-[#ff9472] via-[#ff909c] to-[#f2709c] bg-gradient-to-r shadow-[inset_2px_1000px_1px_#fff] active:scale-[0.98]  my-16 flex flex-row items-center"
            href="/"
          >
            <FontAwesomeIcon
              icon={faArrowLeft}
              ...
              id="leftArrow"
            />
            <span className="text-center font-bold text-[1.1rem] my-0 mx-1.5 text-[#3d3d3d]  ">
              Back to Home page
            </span>
          </Link>
        </div>
