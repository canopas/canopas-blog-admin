            ...
            <div className="justify-self-center xl:justify-self-end xl:order-last">
              ...
              >
                ...
                <button className="hidden md:block rounded-full border-[1px] border-solid border-transparent bg-gradient-to-r from-[#f2709c] to-[#ff9472] hover:shadow-[inset_2px_1000px_1px_#fff] text-white">
                  <div className="py-[0.63rem] px-[0.5rem] md:px-[1.1rem] text-md md:text-xl gradient-text inline-block">
                    Subscribe
                  </div>
                </button>
                <button className="md:hidden w-[45px] h-[45px] rounded-full border-[1px] border-solid border-transparent bg-gradient-to-r from-[#f2709c] to-[#ff9472] hover:shadow-[inset_2px_1000px_1px_#fff]">
                  <div className="w-[21px] h-[21px] inline-block">
                    <FontAwesomeIcon
                      icon={faBell}
                      className="fab footer-icon w-full h-full gradient-text mt-0.5"
                    />
                  </div>
                </button>
              </form>
