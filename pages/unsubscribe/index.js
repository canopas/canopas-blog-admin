...
export default function Unsubscribe() {
  ...
  if (alerts) {
    setTimeout(() => {
      setAlerts(false);
      window.location.replace(config.CANOPAS_URL + "/resources");
    }, 2000);
  }
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-3 ">
            <button className="w-auto rounded-full border-[1px] border-solid border-transparent bg-gradient-to-r from-[#f2709c] to-[#ff9472] text-[1.1rem] font-semibold text-white hover:shadow-[inset_2px_1000px_1px_#fff] hover:cursor-pointer">
              <div
                className="px-[1.35rem] py-[0.3rem] align-middle text-center tracking-wider gradient-text capitalize"
            ...
            <Link
              href={config.CANOPAS_URL + "/resources"}
              onClick={handleLogout}
            >
              <button className="w-auto rounded-full border-[1px] border-solid border-transparent bg-gradient-to-r from-[#f2709c] to-[#ff9472] text-[1.1rem] font-semibold text-white hover:shadow-[inset_2px_1000px_1px_#fff] hover:cursor-pointer">
                <div className="px-[1.35rem] py-[0.3rem] align-middle text-center tracking-wider gradient-text capitalize">
                  no
                </div>
              </button>
            </Link>
